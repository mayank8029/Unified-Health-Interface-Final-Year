            ...
            <section id="contact" className="contact mt-5 mb-5">
                        ...
                        <div className="col-lg-4">
                            <div className="info rounded p-3" style={{ background: '#f8f9fa' }}>
                                <div className="d-flex mb-2 gap-2">
                                    ...
                                    <div>
                                        <h4>Location:</h4>
                                        <p>11 Maheshwari Nagar , Pali Rajasthan</p>
                                    </div>
                                </div>
                ...
                <div>
                    <div className="container">
                        ...
                        <iframe style={{ border: 0, width: "100%", height: "350px" }} src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce31ef9f6eb6b%3A0x5a5997ed0b23d7b2!2sNew%20Delhi!5e0!3m2!1sen!2sin!4v1621410469466" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </section>
            <Footer />
